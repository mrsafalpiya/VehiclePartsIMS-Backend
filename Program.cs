...
using IInvoiceService = VehiclePartsIMS_Backend.Services.IInvoiceService;
using InvoiceService = VehiclePartsIMS_Backend.Services.Implementations.InvoiceService;
using IPartRequestService = VehiclePartsIMS_Backend.Services.Interfaces.IPartRequestService;
using PartRequestService = VehiclePartsIMS_Backend.Services.Implementations.PartRequestService;
